...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/media/zhyang/Data/checkpoints', help='models are saved here')

        # hidden
        self.parser.add_argument('--n_pic', type=int, default=1, help='input pic number')
